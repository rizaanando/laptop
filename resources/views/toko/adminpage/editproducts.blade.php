  ...
  @method('PUT')
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="product_id" name="product_id" required>
            <option value="0024" {{ old('product_id', $product->product_id) == '0024' ? 'selected' : '' }}>0024</option>
            <option value="0078" {{ old('product_id', $product->product_id) == '0078' ? 'selected' : '' }}>0078</option>
        </select>
    </div>
